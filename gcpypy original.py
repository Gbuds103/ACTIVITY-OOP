...
root= Tk()
root.title(" STUDENT PERSONAL INFO")
...
def submit():
    conn=sqlite3.connect('D:/gcpypy/gcpersonalinfo.db')
...
def query():
    ...
    for record in records:
        ...
        query_label=Label(root,text=print_records, bg='lightyellow', fg='blue')
...
def edit():
    ...
    f_name_label=Label(editor,text="First Name", bg='lightgreen')
    f_name_label.grid(row=0,column=0,pady=(10,0))
    l_name_label=Label(editor,text="Last Name", bg='lightgreen')
    l_name_label.grid(row=1,column=0)
    age_label=Label(editor,text="Age", bg='lightgreen')
    age_label.grid(row=2,column=0)
    address_label=Label(editor,text="Address", bg='lightgreen')
    address_label.grid(row=3,column=0)
    email_label=Label(editor,text="Email", bg='lightgreen')
    ...
    save_btn=Button(editor,text="Save Record",command=update, bg='lightcoral', fg='white')
...
f_name_label=Label(root,text="First Name", bg='pink')
f_name_label.grid(row=0, column=0)
l_name_label=Label(root,text="Last Name", bg='pink')
l_name_label.grid(row=1, column=0)
age_label=Label(root,text="Age", bg='pink')
age_label.grid(row=2, column=0)
address_label=Label(root,text="Address", bg='pink')
address_label.grid(row=3, column=0)
...
submit_btn=Button(root,text="Add Record",command=submit, bg='hotpink', fg='black')
submit_btn.grid(row=6,column=0,columnspan=2,pady=10,padx=10,ipadx=100)

query_btn=Button(root,text="Show Records",command=query, bg='hotpink', fg='black')
query_btn.grid(row=7,column=0,columnspan=2,pady=10,padx=10,ipadx=137)

query_btn=Button(root, text="Delete Record", command=delete, bg='hotpink', fg='black')
query_btn.grid(row=12, column=0, columnspan=2, pady=10, padx=10, ipadx=136)

update_btn=Button(root,text="Edit Record",command=edit, bg='hotpink', fg='black')
